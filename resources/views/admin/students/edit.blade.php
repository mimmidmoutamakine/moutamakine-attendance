                    ...
                    <form method="POST" action="{{ route('admin.students.update', $student) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" rows="3"
                                      class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 shadow-sm placeholder:text-slate-400 focus:border-sky-400 focus:ring-2 focus:ring-sky-300/70 transition-colors duration-150">{{ old('notes', $student->notes) }}</textarea>
                        </div>
